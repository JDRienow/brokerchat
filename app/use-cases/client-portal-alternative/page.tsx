  ...
  return (
    <main className="px-4 py-12">
      <div className="container mx-auto max-w-3xl">
        <h1 className="text-4xl font-bold mb-4">Client Portal Alternative for Real Estate</h1>
        <p className="text-gray-700 mb-6">
          Share a single link where clients ask questions and receive cited answers from your PDFs.
          Get analytics on engagement instead of digging through email threads.
        </p>
        ...
        <p className="text-gray-700 mb-4">Clients want answers, not logins. om2chat gives them both—fast answers and transparent citations.</p>
