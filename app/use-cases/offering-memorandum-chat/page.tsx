  ...
  return (
    <main className="px-4 py-12">
      <div className="container mx-auto max-w-3xl">
        <h1 className="text-4xl font-bold mb-4">Offering Memorandum (OM) Chatbot for CRE</h1>
        <p className="text-gray-700 mb-6">
          Turn your Offering Memorandum into an interactive Q&amp;A experience. Upload your OM PDF,
          share a public chat link, and let buyers ask questions with cited answers from the source pages.
        </p>
        ...
        <p className="text-gray-700 mb-4">
          Buyers get instant, accurate answers; you capture engagement data to qualify faster.
          No downloads required, just a link.
        </p>
        ...
        <ul className="list-disc pl-6 text-gray-700">
          ...
          <li><Link href="/residential" className="underline">AI for agents</Link></li>
        </ul>
      </div>
    </main>
  );
